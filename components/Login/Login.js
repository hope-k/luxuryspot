...
const Login = () => {
    useEffect(() => {
        notification.info({
            ...
            description: "Login in as admin to create, read, update and delete room, users, bookings etc. Use these logins to login as an admin. || Email: admin@gmail.com || Password: kumordzie. NOTE: Login with your real email so you can receive an email after booking a room"
        })
    }, [])
