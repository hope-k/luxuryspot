        ...
        <>

            {
                roomLoading ? <Loader /> : (
                    ...
                    <div className="container container-fluid fw-bold">
                        <div className="row wrapper">
                            <div className="col-10 col-lg-8">
                                <form onSubmit={onSubmit} className="shadow-lg addRadius formBackground" enctype="multipart/form-data">
                                    <h1 className="mb-4  rale">Update Room</h1>
