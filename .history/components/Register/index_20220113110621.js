                                ...
                                <div className='d-flex align-items-center'>
                                    ...
                                    <div>
                                        <input
                                            ...
                                            id='customFile'
                                            accept=''
                                            accept="images/*/application/msword,image/gif,image/jpeg,application/pdf,image/png,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/zip,.doc,.gif,.jpeg,.jpg,.pdf,.png,.xls,.xlsx,.zip" 
                                            onChange={onChange}
                                        />
